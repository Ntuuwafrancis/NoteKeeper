...
import com.frank.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch){
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.frank.notekeeper.provider.courses
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch){
            case NOTES:
                ...
                // content://com.frank.notekeeper.provider/notes/1
