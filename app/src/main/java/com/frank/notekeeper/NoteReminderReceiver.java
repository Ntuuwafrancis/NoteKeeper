...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "com.frank.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.frank.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID ="com.frank.notekeeper.extra.NOTE_ID";
